...
#SBATCH --output=QualityCheck_NewHC_MGMs_ABSrevise.stdout
#SBATCH --mail-user=lfreund@health.ucsd.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="QualityCheck_NewHC_MGMs_ABSrevise"
...
for FILE in ${workplace}/HC_Seqs/*.fastq;
do
    #f=$(basename $FILE)
    #SAMPLE=${f%.fastq}
...
multiqc ${workplace}/FastQC_Results/MGM_PreTrim_FastQC/ -o ${workplace}/FastQC_Results/MGM_PreTrim_FastQC/
