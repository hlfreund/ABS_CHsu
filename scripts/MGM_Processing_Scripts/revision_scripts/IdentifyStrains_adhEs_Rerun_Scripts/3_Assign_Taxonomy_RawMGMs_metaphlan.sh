...
#SBATCH --output=Assign_Taxonomy_RawMGMs_metaphlan_07.30.25.stdout
#SBATCH --mail-user=lfreund@health.ucsd.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="Assign_Taxonomy_RawMGMs_metaphlan_rd2"
