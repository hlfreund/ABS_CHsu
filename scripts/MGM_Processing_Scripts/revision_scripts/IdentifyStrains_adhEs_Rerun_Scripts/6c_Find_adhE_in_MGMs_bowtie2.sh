...
#SBATCH --output=Find_adhE_in_MGMs_bowtie2.stdout
#SBATCH --mail-user=lfreund@health.ucsd.edu
#SBATCH --mail-type=ALL
#SBATCH --job-name="Find_adhE_in_MGMs_bowtie2"
...
if [[ ! -d ${workplace}/Bowtie2_adhE_Results ]]; then
    mkdir ${workplace}/Bowtie2_adhE_Results
fi
...
results_dir=${workplace}/Bowtie2_adhE_Results
